...
$result1 = mysql_query("SELECT * FROM records WHERE coach_id= '".$_SESSION['id']."' ORDER BY id DESC");
if(false === $result1){
	echo mysql_error();
...
echo "<td><a href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"delete.php?tt_number=$res[tt_number]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>"; 
}
?>
</table> 
</body>
